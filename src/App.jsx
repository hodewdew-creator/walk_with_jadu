 ...
 *  변경점:
 *  - 쿠팡 광고를 화면 고정(fixed)에서 일반 블록으로 변경 → 앱 맨 하단에 자연스럽게 배치 (스크롤 시 맨 아래에서 보임)
 *  - footerRef/높이 측정 및 본문 paddingBottom 제거
 *  - CoupangAd: forwardRef 제거, 단순 함수형으로 교체
 */
...
// ★ 변경됨: forwardRef 제거, 고정 해제, 일반 블록으로 하단 배치
function CoupangAd(){
  return (
